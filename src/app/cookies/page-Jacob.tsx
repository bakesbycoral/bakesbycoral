...
export default function CookiesPage() {
  const cookieFlavors = [
    { name: 'Chocolate Chip', description: 'Classic soft & chewy with semi-sweet chocolate chips' },
    { name: 'Double Chocolate', description: 'Rich chocolate cookie with chocolate chips' },
    { name: 'Snickerdoodle', description: 'Buttery cinnamon sugar cookie' },
    { name: 'Peanut Butter', description: 'Soft peanut butter cookie with a crinkle top' },
    { name: 'Oatmeal Raisin', description: 'Chewy oats with plump raisins' },
    { name: 'Sugar Cookie', description: 'Classic vanilla sugar cookie' },
  ];
      ...
      <section className="py-16 sm:py-24 bg-[#F7F3ED]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <p className="text-lg text-stone-600 leading-relaxed mb-12">
            ...
            with gluten-free ingredients that taste just like the real thing.
          </p>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-xl font-serif text-[#541409] mb-2">1 Dozen</h3>
              <p className="text-3xl font-bold text-[#541409]">$25</p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-xl font-serif text-[#541409] mb-2">2 Dozen</h3>
              <p className="text-3xl font-bold text-[#541409]">$48</p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-xl font-serif text-[#541409] mb-2">4+ Dozen</h3>
              <p className="text-lg font-medium text-[#541409]">Starting at $95</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-24 bg-[#EAD6D6]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-lg text-stone-700 leading-relaxed mb-8">
            ...
            Perfect for weddings, showers, corporate events, and parties.
          </p>
          <Link
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-stone-600 text-sm">
                You can mix flavors! Get a variety in your dozen.
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-sm">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-stone-600 text-sm">
                Cookies come packaged in a bakery box, ready for gifting or enjoying.
              </p>
            </div>
          </div>
        </div>
