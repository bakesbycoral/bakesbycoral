          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="group bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="px-3 py-1 bg-[#EAD6D6] text-[#541409] text-sm rounded-full">Starting at $50</span>
            ...
            <div className="group bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="px-3 py-1 bg-[#EAD6D6] text-[#541409] text-sm rounded-full">$25/dozen</span>
