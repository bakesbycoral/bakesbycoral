                  ...
                  {isSeasonalLive && (
                    <>
                      <div className="pt-4 border-t border-[#EAD6D6]">
                        <p className="text-sm font-medium text-[#541409] mb-3 flex items-center gap-2">
                          <span className="px-2 py-0.5 bg-[#541409] text-[#EAD6D6] rounded text-xs">SEASONAL</span>
