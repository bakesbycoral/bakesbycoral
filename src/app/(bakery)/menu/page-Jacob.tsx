            ...
            <div>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex justify-between items-center border-b border-stone-200 pb-2">
                  ...
                  <span className="text-stone-600">Starting at $50</span>
                </div>
                <div className="flex justify-between items-center border-b border-stone-200 pb-2">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex justify-between items-center border-b border-[#541409]/20 pb-2">
                  ...
                  <span className="text-stone-700">$48</span>
                </div>
                <div className="flex justify-between items-center border-b border-[#541409]/20 pb-2">
                  <span className="font-medium text-[#541409]">Large Orders (4+ dozen)</span>
                  <span className="text-stone-700">Starting at $95</span>
                </div>
              </div>
