          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div>
              <Link href="/order/cake" className="aspect-square rounded-lg overflow-hidden block">
                <img src="/christmas-cake.jpg" alt="6 inch heart cake" className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" style={{ objectPosition: 'center 30%' }} />
              </Link>
              <p className="text-center text-stone-600 text-sm mt-2">6" Heart</p>
            </div>
            <div>
              <Link href="/order/cake" className="aspect-square rounded-lg overflow-hidden block">
                <img src="/49rs-cake.jpg" alt="6 inch round cake" className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" />
              </Link>
              <p className="text-center text-stone-600 text-sm mt-2">6" Round</p>
            </div>
            <div>
              <Link href="/order/cake" className="aspect-square rounded-lg overflow-hidden block">
            ...
            <div>
              <Link href="/order/cake" className="aspect-square rounded-lg overflow-hidden block">
                <img src="/bride-tini.jpg" alt="6 inch heart cake" className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" />
              </Link>
              <p className="text-center text-stone-600 text-sm mt-2">6" Heart</p>
            </div>
          </div>
