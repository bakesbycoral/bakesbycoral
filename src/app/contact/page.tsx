    ...
    try {
      const response = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          message: `[${formData.subject}] ${formData.message}${formData.phone ? `\n\nPhone: ${formData.phone}` : ''}`,
        }),
      });
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    id="subject"
                    required
                    className={`w-full px-4 py-3 border border-stone-300 rounded-sm focus:outline-none focus:ring-2 focus:ring-[#541409] focus:border-transparent bg-white ${formData.subject ? 'text-[#541409]' : 'text-[#541409]/50'}`}
                ...
                <button
                  ...
                  className="w-full px-8 py-4 bg-[#541409] text-[#EAD6D6] font-medium rounded-sm hover:opacity-80 transition-opacity disabled:opacity-50"
                >
