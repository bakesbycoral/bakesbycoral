-- Migration 016: Add 'mothers_day_collection' to order_type CHECK constraint

-- Step 1: Create new table with updated constraint
CREATE TABLE orders_new (
  id TEXT PRIMARY KEY,
  order_number TEXT NOT NULL UNIQUE,
  order_type TEXT NOT NULL CHECK (order_type IN ('cookies', 'cookies_large', 'cake', 'wedding', 'tasting', 'easter_collection', 'cookie_cups', 'mothers_day_collection')),
